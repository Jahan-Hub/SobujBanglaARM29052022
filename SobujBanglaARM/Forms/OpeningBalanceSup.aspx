<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpeningBalanceSup.aspx.cs" Inherits="SobujBanglaARM.Forms.OpeningBalanceSup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>Supplier Opening Balance Entry</h1>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmPartyName" Runat="server" Width="100%" EnableLoadOnDemand="true" EmptyMessage="Select Supplier" OnItemsRequested="cmPartyName_ItemsRequested" AutoPostBack="True"  Filter="Contains" Height="500px" DropDownAutoWidth="Enabled" OnSelectedIndexChanged="cmPartyName_SelectedIndexChanged">
                        <HeaderTemplate>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Bill No &amp; Date"></asp:Label>
                </td>
                <td>
                    <telerik:RadTextBox ID="txtInvoiceNo" Runat="server" LabelWidth="64px" Resize="None" Width="160px">
                    </telerik:RadTextBox>
                    <telerik:RadDatePicker ID="dpBillDate" Runat="server" Culture="en-US" Width="100px">
