...
{
    public partial class rptStockDetails : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand Cmd;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AppEnv.Current.p_rptObject = "~/Reports/StockDetails.rpt";
                tempPath = @System.IO.Path.GetTempPath() + "StockDetails";
                reportName = "StockDetails";
                ...
                if (dt.Rows.Count > 0) // need to get data by stock entry date
                {
