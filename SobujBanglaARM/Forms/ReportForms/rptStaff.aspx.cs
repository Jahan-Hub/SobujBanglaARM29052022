...
{
    public partial class rptStaff : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand Cmd;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add("@mode", SqlDbType.VarChar).Value = 15;
                Cmd.Parameters.Add("@IdClient", SqlDbType.VarChar).Value = AppEnv.Current.p_IdClient;
                ...
                string tempPath = "";
                string reportName = "";
                AppEnv.Current.p_rptObject = "~/Reports/Staff.rpt";
                tempPath = @System.IO.Path.GetTempPath() + "StaffInfo";
                reportName = "StaffInfo";
