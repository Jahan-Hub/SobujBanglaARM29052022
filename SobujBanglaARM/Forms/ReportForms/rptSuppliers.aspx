<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSuppliers.aspx.cs" Inherits="SobujBanglaARM.Forms.rptSuppliers" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Supplier" OnItemsRequested="cmCommon_ItemsRequested" Width="300px" AutoPostBack="True" Enabled="False">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
