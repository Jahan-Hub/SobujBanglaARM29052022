<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptStaff.aspx.cs" Inherits="SobujBanglaARM.Forms.ReportForms.rptStaff" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Staff" OnItemsRequested="cmCommon_ItemsRequested" Width="300px" AutoPostBack="True" Enabled="False">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
