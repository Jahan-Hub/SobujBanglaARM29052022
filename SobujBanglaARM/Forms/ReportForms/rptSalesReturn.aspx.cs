...
{
    public partial class rptSalesReturn : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand Cmd;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string tempPath = "";
                string reportName = "";
                AppEnv.Current.p_rptObject = "~/Reports/SalesReturn.rpt";
                tempPath = @System.IO.Path.GetTempPath() + "SalesReturn";
                reportName = "SalesReturn";
