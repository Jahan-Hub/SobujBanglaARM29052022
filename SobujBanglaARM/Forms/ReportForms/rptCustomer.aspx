<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptCustomer.aspx.cs" Inherits="SobujBanglaARM.Forms.rptCustomer" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Enabled="false" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Customer" OnItemsRequested="cmCommon_ItemsRequested" Width="300px">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
