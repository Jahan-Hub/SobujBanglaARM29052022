<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSalary.aspx.cs" Inherits="SobujBanglaARM.Forms.ReportForms.rptSalary" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Staff" OnItemsRequested="cmCommon_ItemsRequested" Width="300px" Filter="Contains">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
