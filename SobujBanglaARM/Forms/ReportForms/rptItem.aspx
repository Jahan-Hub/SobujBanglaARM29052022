<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptItem.aspx.cs" Inherits="SobujBanglaARM.Forms.rptItem" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Product" OnItemsRequested="cmCommon_ItemsRequested" Width="300px" Filter="Contains" DropDownAutoWidth="Enabled" Height="400px">
                        <HeaderTemplate>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label20" runat="server" Text="Item Size" Visible="False"></asp:Label>
                </td>
                <td>
                    <telerik:RadComboBox ID="cmItemSize" Runat="server" EnableLoadOnDemand="true" AutoPostBack="True" EmptyMessage="Select Item Size" OnItemsRequested="cmItemSize_ItemsRequested" Visible="False">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
