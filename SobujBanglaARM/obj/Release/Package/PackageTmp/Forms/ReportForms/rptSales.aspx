<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSales.aspx.cs" Inherits="SobujBanglaARM.Forms.rptSales" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td colspan="2">
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Customer" OnItemsRequested="cmCommon_ItemsRequested" Width="300px" Filter="Contains">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style1" colspan="2">
                    <telerik:RadComboBox ID="cmCategory" Runat="server" DataSourceID="dsCat" DataTextField="Name" DataValueField="CatId" EmptyMessage="Select Category" AutoPostBack="True" OnSelectedIndexChanged="cmCategory_SelectedIndexChanged" Filter="Contains">
                    </telerik:RadComboBox>
            ...
            <tr>
                ...
                <td class="auto-style1" colspan="2">
                            <telerik:RadComboBox ID="cmItemName" Runat="server" Width="100%" AutoPostBack="True" EmptyMessage="Select Product" EnableLoadOnDemand="true" DropDownAutoWidth="Enabled" Height="400px" Filter="Contains">
                                    <HeaderTemplate>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                ...
                <td>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Summary" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" />
                </td>
            </tr>
             <tr>
                <td>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                ...
                <td>
                    <asp:CheckBox ID="ckOpeningBalance" runat="server" Text="Opening Balance" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" />
                </td>
            </tr>
            <tr>
                <td>
