<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptBankTransactions.aspx.cs" Inherits="SobujBanglaARM.Forms.ReportForms.rptBankTransactions" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Bank">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style1">
                    <telerik:RadComboBox ID="cmTransactionType" Runat="server" AutoPostBack="True" EmptyMessage="Select Transaction Type">
                        <Items>
