<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptMoneyReceive.aspx.cs" Inherits="SobujBanglaARM.Forms.ReportForms.rptMoneyReceive" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" EnableLoadOnDemand="true" EmptyMessage="Select Customer" OnItemsRequested="cmCommon_ItemsRequested" Width="250px" AutoPostBack="True" Filter="Contains" DropDownAutoWidth="Enabled" Height="400px">
                         <HeaderTemplate>
